...
function LoginPage() {
  ...
  const HandleSubmit = async (e) => {
    ...
    setLoading(true);
    if (formData.email === "x@gmail.com" || formData.password === "abcd") {
  ...
  return (
    <div className="min-h-screen bg-[#161620] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Ambient glows */}
